...
class TestDecisionTreeModel(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.processor.model = DecisionTreeClassifier(random_state=42)  # Khởi tạo mô hình Decision Tree
    ...
    def test_save_and_load_model(self):
        ...
        # Lưu mô hình
        ret = self.processor.saveModel("/Users/minhtan/Documents/GitHub/MLinBA/Final_MLinBA/Assets/WithOversampling/DecisionTree_model.zip")
