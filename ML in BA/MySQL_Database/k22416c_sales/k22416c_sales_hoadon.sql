...
CREATE TABLE `hoadon` (
  ...
  `mahoadon` varchar(50) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `ngaylapHD` datetime DEFAULT NULL,
  `idnhanvien` int DEFAULT NULL,
  `status` int DEFAULT NULL,
  `ghichu` varchar(5000) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
INSERT INTO `hoadon` VALUES (1,'HD1','0001-01-25 00:00:00',1,1,'DA THANH TOAN',2),(2,'HD2','0002-02-25 00:00:00',1,1,'DA THANH TOAN',1);
